...
public:
    CMainParams()
    {
        ...
        consensus.nDigiSheildHFHeight = INT_MAX; //TODO akshaynexus set this for Mainnet
        /**
...
public:
    CTestNetParams()
    {
        ...
        consensus.nLocalTargetAdjustment = 4; //target adjustment per algo
        /* End DigiShield params */
        consensus.nDigiSheildHFHeight = INT_MAX; //TODO akshaynexus set this for Testnet
...
public:
    CRegTestParams()
    {
        ...
        consensus.nLocalTargetAdjustment = 4; //target adjustment per algo
        /* End DigiShield params */
        consensus.nDigiSheildHFHeight = INT_MAX; //TODO akshaynexus set this for Regtest
